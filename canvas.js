...
canvas.width = (innerWidth - 10) * 0.4
...
const initPlanet = () => {
    ...
    ctx.drawImage(planet, planet.width/50, 0 ,planet.width/50, planet.height, 0, 0, 300, 300);
}
...
setInterval(function()
{
    ...
    ctx.drawImage(planet, column, 0 ,planet.width/50, planet.height, 0, 0, 300, 300);
}, 120);
